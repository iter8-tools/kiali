...
func (in *Iter8Service) GetIter8ExperimentTemplates() ([]models.Iter8ExperimentTemplate, error) {
	...
	return templateSpecs, err
}

func getNameFromConfig() (string, string) {
	templateConfigMap := "iter8-experiment-templates"
	namespace := "iter8"
	conf := config.Get()
	if conf.Extensions.Iter8.TemplateConfigMap != "" {
